...
from metar_tester.question_collector import UsuableDataError
...
class TestCreateDbAnswers(TestCase):
    ...
    def setUp(self):
        ...
        db_airport.save()
        metar_path = os.path.join(os.getcwd(), 'metar_tester', 'tests', 'static', 'question_collector', 'sample_metar.json')
...
class TestCreateDbQuestion(TestCase):
    ...
    @mock.patch('metar_tester.question_collector.QuestionColllector.create_db_answers')
...
class TestGenerateTypeQustion(TestCase):
    ...
    @mock.patch('metar_tester.question_collector.QuestionColllector.create_db_question')
    ...
    def test_generate_cloud_coverage_question_all(self, mock_question_collector_db_question):
        metar_path = os.path.join(os.getcwd(), 'metar_tester', 'tests', 'static', 'question_collector', 'sample_metar_cloud_coverage_all.json')
        db_metar = self.helper_create_metar_object(metar_path, self.db_airport)
        question_collector = QuestionColllector(db_metar, self.sample_count)
        question_text = 'What is the reported cloud coverage?'
    ...
    def test_generate_cloud_coverage_question_clouds_duplicates(self, mock_question_collector_db_question):
        metar_path = os.path.join(os.getcwd(), 'metar_tester', 'tests', 'static', 'question_collector', 'sample_metar_cloud_coverage_duplicates.json')
        db_metar = self.helper_create_metar_object(metar_path, self.db_airport)
        question_collector = QuestionColllector(db_metar, self.sample_count)
        question_text = 'What is the reported cloud coverage?'
    ...
    def test_generate_cloud_coverage_question_clouds_empty(self, mock_question_collector_db_question):
        metar_path = os.path.join(os.getcwd(), 'metar_tester', 'tests', 'static', 'question_collector', 'sample_metar_clouds_empty.json')
        db_metar = self.helper_create_metar_object(metar_path, self.db_airport)
        question_collector = QuestionColllector(db_metar, self.sample_count)
        db_question = self.helper_create_db_question(db_metar, 'This is a test question string', ['This is a test answer string'])
        mock_question_collector_db_question.return_value = db_question
...
class TestGenerateQuestions(TestCase):
    ...
    @mock.patch('metar_tester.question_collector.QuestionColllector.generate_cloud_ceiling_questions')
    @mock.patch('metar_tester.question_collector.QuestionColllector.generate_cloud_height_question')
    @mock.patch('metar_tester.question_collector.QuestionColllector.generate_cloud_coverage_question')
    @mock.patch('metar_tester.question_collector.QuestionColllector.generate_visibility_question')
    @mock.patch('metar_tester.question_collector.QuestionColllector.generate_dewpoint_question')
    @mock.patch('metar_tester.question_collector.QuestionColllector.generate_temperature_question')
    @mock.patch('metar_tester.question_collector.QuestionColllector.generate_altimeter_question')
    @mock.patch('metar_tester.question_collector.QuestionColllector.generate_wind_gust_question')
    @mock.patch('metar_tester.question_collector.QuestionColllector.generate_wind_speed_question')
    @mock.patch('metar_tester.question_collector.QuestionColllector.generate_wind_direction_question')
    @mock.patch('metar_tester.question_collector.QuestionColllector.generate_time_question')
    @mock.patch('metar_tester.question_collector.QuestionColllector.generate_airport_question')
