...
from metar_tester import metar_collector
...
class TestGetRawMetar(TestCase):
    ...
    def test_get_raw_metar_airport_exists(self):
        metar_collector_class = metar_collector.MetarCollector()
        icao = 'KJFK'
        ...
        db_airport.save()
        metar_path = os.path.join(os.getcwd(), 'metar_tester', 'tests', 'static', 'metar_collector', 'sample_metar.json')
    ...
    def test_get_raw_metar_airport_already_exists(self):
        ...
        self.assertEquals(status_code, 200)
        self.assertEquals(returned_db_metar, db_metar)
        self.assertIsNotNone(self.get_db_airport(db_airport.pk))
    ...
    def test_get_raw_metar_airport_error_airport_does_not_exist(self):
        ...
        db_airport = Airport(name='Emerald Airport',
                             ...
                             longitude='58.38974')
        db_airport.save()
        error_path = os.path.join(os.getcwd(), 'metar_tester', 'tests', 'static', 'metar_collector', 'sample_metar_error.json')
        ...
        self.assertIsNone(self.get_db_airport(db_airport.pk))
